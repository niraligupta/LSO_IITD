              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    <th className="text-right py-3 font-semibold">    Late Fee (in rupees)<br></br>(<s className="text-muted-foreground decoration-red-500">until 15 April 2026 </s> <span className="text-black font-semibold">until 26 May 2026 Time: 02: 59 PM </span>)</th>
                  </tr>
                </thead>
                <tbody>
                  {fees.map((item) => (
