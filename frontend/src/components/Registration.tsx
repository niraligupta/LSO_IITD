              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    <th className="text-right py-3 font-semibold"> Early Bird Fee (in rupees) <br></br>(until 28 March 2026)</th>
                    <th className="text-right py-3 font-semibold">    Late Fee (in rupees)<br></br>(until 15 April 2026)</th>
                  </tr>
                </thead>
                <tbody>
                  {fees.map((item) => (
